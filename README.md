...
After running filebeat and metric beats the following screen is displayed and indicated the succes of each step of the playbooks, on the kibana side it dsiplays that it is receiving data from that module
